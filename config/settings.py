...
UNFOLD = {
    ...
    'SITE_FAVICONS': [
        {
            ...
            'sizes': '16x16',
            'type': 'image/png',
            'href': lambda request: static('img/favicon-16.png') + '?v=7',
        },
        {
            'rel': 'icon',
            'sizes': '32x32',
            'type': 'image/png',
            'href': lambda request: static('img/favicon-32.png') + '?v=7',
        },
        {
            'rel': 'apple-touch-icon',
            'sizes': '180x180',
            'type': 'image/png',
            'href': lambda request: static('img/favicon-180.png') + '?v=7',
        },
    ],
    'SHOW_HISTORY': True,
    ...
    'STYLES': [
        lambda request: static('css/admin/site_content.css') + '?v=14',
    ],
    'SCRIPTS': [
