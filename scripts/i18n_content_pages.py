...
PAGES_EXACT: dict[str, tuple[str, str]] = {
    ...
    'Головна': ('Home', '首页'),
    'Блог': ('Blog', '博客'),
    'Гід і культура': ('Guide & culture', '指南与文化'),
    'Практичні гіди про сигари, зберігання, аксесуари та смак — від сомельє Royal Smoke.': (
        'Practical guides on cigars, storage, accessories, and taste — from Royal Smoke sommeliers.',
        '来自 Royal Smoke 侍茄师的雪茄、储存、配件与风味实用指南。',
    ),
    'Блог Royal Smoke: як обрати сигару, зберігати в хумідорі, підібрати аксесуари та читати вітолу. Поради експертів.': (
        'Royal Smoke blog: how to choose a cigar, store it in a humidor, pick accessories, and read a vitola. Expert tips.',
        'Royal Smoke 博客：如何选购雪茄、在保湿盒中保存、挑选配件并阅读维托拉。专家建议。',
    ),
    'Читати': ('Read', '阅读'),
    'Усі статті': ('All articles', '全部文章'),
    'Читайте також': ('Read also', '相关阅读'),
