...
_SECTION_MODELS = (
    ...
    (HomeCatalogSettings, 'home', 'catalog'),
    (HomeAboutSettings, 'home', 'about'),
    (HomeCalculatorSettings, 'home', 'calculator'),
    (HomeServiceSettings, 'home', 'service'),
    (AboutPageSettings, 'about', 'page'),
    (BlogPageSettings, 'blog', 'page'),
    (FaqPageSettings, 'faq', 'page'),
    (ContactPageSettings, 'contact', 'page'),
    (DeliveryPageSettings, 'delivery', 'page'),
    (B2bPageSettings, 'b2b', 'page'),
    (BookingPageSettings, 'booking', 'page'),
    (CatalogPageSettings, 'catalog', 'page'),
    (CartPageSettings, 'cart', 'page'),
